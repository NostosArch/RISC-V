...
HD_PWD='/home/abhishek/Verilog/Processor/Processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_CPU.vds -m64 -mode batch -messageDb vivado.pb -notrace -source RV32I_CPU.tcl
